...
function App() {
  ...
  const fetchAirdrops = async () => {
    try {
      const response = await axios.get('http://13.60.190.243:8000/api/airdrops');
  ...
  const fetchAirdropCount = async () => {
    try {
      const response = await axios.get('http://13.60.190.243:8000/api/airdrops/count');
  ...
  const fetchParentTotal = async () => {
    try {
      const response = await axios.get('http://13.60.190.243:8000/api/airdrops/sum');
  ...
  const fetchCurrentCumulativeTotal = async () => {
    try {
      const response = await axios.get('http://13.60.190.243:8000/api/airdrops/currentCumulativeTotal');
  ...
  const fetchCumulativeTotal = async () => {
    try {
      const response = await axios.get('http://13.60.190.243:8000/api/airdrops/incrementCumulative');
      setCumulativeTotal(response.data.cumulativeTotal); // Update cumulative total
    } catch (error) {
      console.error('Error fetching cumulative total:', error);
  ...
  const deleteAllAirdrops = async () => {
    try {
      const response = await axios.delete('http://13.60.190.243:8000/api/airdrops/deleteAll');
