...
const StarryBackground: React.FC = () => {
    ...
    const createStars = (numStars: number): JSX.Element[] => {
        ...
        const minSpeed = 50; // Slower minimum speed (100 seconds)
        const maxSpeed = 100; // Slower maximum speed (150 seconds)
    ...
    return (
        <div className="fixed inset-0 overflow-hidden bg-gradient-to-b from-[#0D2E48] to-[#0D151A]"> {/* Set background color */} 
            {stars}
