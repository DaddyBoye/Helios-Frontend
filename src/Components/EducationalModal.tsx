...
const EducationalModal: React.FC<EducationalModalProps> = ({ isOpen, onClose, content }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4" onClick={handleOutsideClick}>
            <Card className="w-full max-w-md bg-gradient-to-br from-emerald-50 to-teal-50 shadow-xl relative" onClick={(e) => e.stopPropagation()}>
                <CardContent className="p-4">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-lg font-bold text-emerald-800 line-clamp-1">{currentSlide.title}</h2>
                        </div>
                        ...
                        <p className="text-sm text-emerald-800 line-clamp-3">{currentSlide.content}</p>
